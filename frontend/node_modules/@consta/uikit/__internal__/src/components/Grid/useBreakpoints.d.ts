...
export declare const generateBreakpointsCn: (cn: ClassNameFormatter, breakpoints?: Breakpoints) => string;
/**
 *
 ...
 *
 */
export declare const useBreakpoints: (cn: ClassNameFormatter, breakpoints?: Breakpoints) => string;
export {};
