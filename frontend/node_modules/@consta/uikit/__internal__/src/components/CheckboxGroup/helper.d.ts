...
import { CheckboxGroupDefaultItem, CheckboxGroupPropGetItemDisabled, CheckboxGroupPropGetItemLabel, CheckboxGroupProps } from './types';
export declare const withDefaultGetters: (props: CheckboxGroupProps) => {
    ...
    onChange: (props: {
        ...
        value: CheckboxGroupDefaultItem[] | null;
    }) => void;
