...
export declare const getMonthTitleAbbreviated: (date: Date, locale: Locale) => string;
export declare const getYearTitle: (date: Date) => string;
export declare const getMouthLabelWithYear: (date: Date, locale: Locale) => string;
export declare const getDecadeTitle: (date: Date) => string;
export declare const getLabelHours: (date: Date) => string;
export declare const getLabelMinutes: (date: Date) => string;
