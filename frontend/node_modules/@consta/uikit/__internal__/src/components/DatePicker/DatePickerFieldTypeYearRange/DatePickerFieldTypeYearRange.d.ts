...
export declare const DatePickerFieldTypeYearRange: React.ForwardRefExoticComponent<Omit<import("../DatePickerFieldTypeYear/helpers").DatePickerFieldTypeYearProps, "id" | "onFocus" | "onBlur" | "onChange" | "name" | "value" | "inputRef" | "leftSide" | "rightSide"> & {
    onChange?: ((props: {
        e: Event;
