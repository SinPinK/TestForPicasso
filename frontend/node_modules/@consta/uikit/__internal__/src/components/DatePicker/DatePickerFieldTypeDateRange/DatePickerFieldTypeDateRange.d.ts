...
export declare const DatePickerFieldTypeDateRange: React.ForwardRefExoticComponent<Omit<import("../DatePickerFieldTypeDate/helpers").DatePickerFieldTypeDateProps, "id" | "onFocus" | "onBlur" | "onChange" | "name" | "value" | "inputRef" | "leftSide" | "rightSide"> & {
    onChange?: ((props: {
        e: Event;
