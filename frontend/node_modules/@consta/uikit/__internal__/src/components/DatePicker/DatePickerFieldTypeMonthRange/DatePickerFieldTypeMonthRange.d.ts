...
export declare const DatePickerFieldTypeMonthRange: React.ForwardRefExoticComponent<Omit<import("../DatePickerFieldTypeMonth/helpers").DatePickerFieldTypeMonthProps, "id" | "onFocus" | "onBlur" | "onChange" | "name" | "value" | "inputRef" | "leftSide" | "rightSide"> & {
    onChange?: ((props: {
        e: Event;
