...
export declare type LayoutPropDirection = typeof layoutPropDirection[number];
...
export declare type LayoutPropVerticalAlign = typeof layoutPropVerticalAlign[number];
...
export declare type LayoutPropHorizontalAlign = typeof layoutPropHorizontalAlign[number];
